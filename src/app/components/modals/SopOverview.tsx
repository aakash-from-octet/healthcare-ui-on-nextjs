...
import { Modal, Flex, Form, Button, Row, Col, Input, Select, Avatar, Table, DatePicker } from 'antd';
...
const SOPOverview: React.FC<SOPOverviewProps> = ({ setOpen, open, viewOnly, handleFinish }) => {
    const [displayData, setDisplayData] = useState<any>(dataSource.slice(0, 8));
        ...
        >
            <div className="modal-lg--header relative">
                ...
                <Flex gap={8} align='center' className='modal-header--breadcrumbs'>
                    <p className={steps === 0 ? 'active' : ''} onClick={()=>{setSteps(0)}}>SOP</p>
                    <ChevronRight />
                                    ...
                                    <Row gutter={[20, 20]}>
                                        ...
                                        <Col span={12}>
                                            <Flex align="center" gap={12}>
                                                ...
                                                <p className="form-feild--seprator">:</p>
                                                <div className="full">
                                                    <Form.Item name="reviewDate" label="" rules={[{ required: true }]} style={{marginBottom: 0}}>
                                                        <DatePicker placeholder='dd/mm/yyyy' format="DD/MM/YYYY" suffixIcon={<DownIcon />} />
                                                    </Form.Item>
                                                </div>
                                            </Flex>
                                        ...
                                        <Col span={12}>
                                            <Flex align="center" gap={12}>
                                                ...
                                                <p className="form-feild--seprator">:</p>
                                                <div className="full">
                                                    <Form.Item name="nextReminder" label="" rules={[{ required: true }]} style={{marginBottom: 0}}>
                                                        <DatePicker placeholder='dd/mm/yyyy' format="DD/MM/YYYY" suffixIcon={<DownIcon />} />
                                                    </Form.Item>
                                                </div>
                                            </Flex>
                    ...
                    <div className='modal-lg--footer'>
                        <Flex justify='space-between' className='footer-content'>
                            ...
                            <Button
                                ...
                                htmlType="submit"
                            >
                                {steps === 0 ? 'Save & Next' : viewOnly ? 'Submit' : 'Create SOP'}
                            </Button>
                        </Flex>
                    </div>
                </Form>
